...
pub(crate) fn tool_specs() -> Vec<Value> {
    vec![
        json!({
            ...
            "inputSchema": generated_schema::<WorkspaceStatusInput>("workspace status schema")
        }),
        json!({
        ...
        json!({
            ...
            "inputSchema": generated_schema::<ApplyPlanInput>("apply plan schema")
        }),
        json!({
            "name": "ae.edit.discard_plan",
            "title": "Discard Plan",
            "description": "Discard a stored edit plan without applying it.",
            "inputSchema": generated_schema::<DiscardPlanInput>("discard plan schema")
        }),
        json!({
            ...
            "inputSchema": generated_schema::<SemanticStatusInput>("semantic status schema")
        }),
        json!({
